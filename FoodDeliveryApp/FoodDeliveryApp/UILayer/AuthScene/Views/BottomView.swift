...
class BottomView: UIView {
    ...
    private func setupButton1(){
        ...
        button1.setImage(UIImage(named: "facebookImage"), for: .normal)
        button1.addTarget(self, action: #selector(button1Tapped), for: .touchUpInside)
        NSLayoutConstraint.activate([
            button1.topAnchor.constraint(equalTo: label.bottomAnchor, constant: 20),
            button1.leadingAnchor.constraint(equalTo: label.leadingAnchor, constant: 0),
    ...
    private func setupButton2(){
        ...
        button2.setImage(UIImage(named: "googleImage"), for: .normal)
